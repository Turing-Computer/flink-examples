//package com.turing.pipeline.proccess;
//
//
//import com.turing.pipeline.example6.OrderEvent;
//import com.turing.pipeline.example6.OrderResult;
...
//
///**
// * @descri 使用ProcessFunction实现订单超时检测
// *
// * @author lj.michale
// * @date 2023-03-14
// */
...
//        DataStream<OrderEvent> orderEventStream = env.readTextFile("")
//                .map(line -> {
...
//                // 如果pay来了，说明create没来
//                ctx.output(orderTimeoutTag, new OrderResult(ctx.getCurrentKey().toString(), "payed but not found created log"));
//            }else {
//                // 如果pay没来，支付超时
//                ctx.output(orderTimeoutTag, new OrderResult(ctx.getCurrentKey().toString(), "timeout"));
//            }
//            // 清空状态
//            isCreatedState.clear();
//            isPayedState.clear();
